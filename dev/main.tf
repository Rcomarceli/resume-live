...
module "backend" {
  source = "github.com/Rcomarceli/resume-modules//backend?ref=v2.0.0"
...
module "frontend" {
  source = "github.com/Rcomarceli/resume-modules//frontend?ref=v2.0.0"
...
module "dns" {
  source = "github.com/Rcomarceli/resume-modules//dns?ref=v2.0.0"
