...
module "backend" {
  source = "github.com/Rcomarceli/resume-modules//backend?ref=v1.0.8"
...
module "frontend" {
  source = "github.com/Rcomarceli/resume-modules//frontend?ref=v1.0.8"
...
module "dns" {
  source = "github.com/Rcomarceli/resume-modules//dns?ref=v1.0.8"
